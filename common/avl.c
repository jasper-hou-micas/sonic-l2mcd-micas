...
avl_find (const struct avl_table *tree, const void *item)
{
  ...
  int offset = *(int *) tree->avl_param;
  for (p = tree->avl_root; p != NULL; )
    {
      int cmp = tree->avl_compare (item, (void *) ((char *)p->avl_data + offset), tree->avl_param);
...
avl_probe (struct avl_table *tree, void *item)
{
  ...
  for (q = z, p = y; p != NULL; q = p, p = p->avl_link[dir])
    {
      int cmp = tree->avl_compare ((void *) ((char *)item+offset), (void *) ((char *)p->avl_data+offset), tree->avl_param);
      if (cmp == 0)
        return &p->avl_data;
...
avl_delete (struct avl_table *tree, const void *item)
{
  ...
  p = (struct avl_node *) &tree->avl_root;
    int offset = *(int *) tree->avl_param;
  for (cmp = -1; cmp != 0;
       cmp = tree->avl_compare ((void *) ((char*)item+offset), (void *) ((char*)p->avl_data + offset), tree->avl_param))
    {
      int dir = cmp > 0;
