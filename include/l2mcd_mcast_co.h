...
#define NOTIFY_PARAM_VLAN_MEMBER_READY	"VLAN_MEMBER_READY"
#define NOTIFY_PARAM_VLAN_MEMBER_REMOVED	"VLAN_MEMBER_REMOVED"
...
extern L2MCD_AVL_TREE *l3_portdb_tree;
